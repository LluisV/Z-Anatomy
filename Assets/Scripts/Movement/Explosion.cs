...
public class Explosion : MonoBehaviour
{
    ...
    {
        foreach (var bodyPart in TranslateObject.Instance.selected.Where(item => !item.GetComponentsInParent<BodyPart>().Any(it => it != item && TranslateObject.Instance.selected.Contains(it))))
        {
