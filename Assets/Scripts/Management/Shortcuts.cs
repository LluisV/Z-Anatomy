...
public class Shortcuts : MonoBehaviour
{
   ...
   // public Key[] brushSizeShortcut; // + mouse scroll
    ...
    private void Left(InputAction.CallbackContext context)
    {
        if (UserIsWriting())
            return;
        CubeBehaviour.instance.SetFaceShortcut(GizmoFace.Left);
    ...
    private void Right(InputAction.CallbackContext context)
    {
        if (UserIsWriting())
            return;
        CubeBehaviour.instance.SetFaceShortcut(GizmoFace.Right);
    ...
    private void Up(InputAction.CallbackContext context)
    {
        if (UserIsWriting())
            return;
        CubeBehaviour.instance.SetFaceShortcut(GizmoFace.Up);
    ...
    private void Down(InputAction.CallbackContext context)
    {
        if (UserIsWriting())
            return;
        CubeBehaviour.instance.SetFaceShortcut(GizmoFace.Down);
