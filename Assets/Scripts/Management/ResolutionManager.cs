...
public class ResolutionManager : MonoBehaviour
{
    ...
    private IEnumerator StartRoutine()
    {
        ...
        InitResolutions();
        Settings.Instance.SetResolutionValues();
        #if !UNITY_EDITOR && UNITY_STANDALONE_WIN
                BorderlessWindow.SetFramelessWindow(!Screen.fullScreen);
        #endif
    }
    ...
    public void SetResolution(int index, bool fullscreen)
    {
        ...
        IEnumerator WaitToScreenChange()
        {
            yield return null;
                    ...
                    BorderlessWindow.SetFramelessWindow(!fullscreen);
            #endif
    ...
    public void ToggleFullscreen(bool fromSettings)
    {
        ...
        Settings.Instance.dropdownResolution.transform.parent.gameObject.SetActive(!Settings.Instance.fullscreenToggle.isOn);
